...
var title,button,runGame,texT,distanceText;
...
function setup() {
  ...
  runGame.mousePressed(()=>{
    ...
    gameOver = createSprite(width-675, height-365);
    gameOver.addImage(gameOverImg);

    restart = createSprite(width-675, height-320);
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    distanceText.html("DISTANCE : "+score);
    distanceText.position(width-475, height-640);
    ...
    obstaclesGroup.depth = distanceText.depth;
    distanceText.depth = distanceText.depth + 1;
    distanceText.html("DISTANCE : "+score);
    distanceText.position(width-810, height-460);

    obstaclesGroup.depth = gameOver.depth;
    gameOver.depth = gameOver.depth + 1;

    obstaclesGroup.depth = restart.depth;
